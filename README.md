...
![alt text](screenshots/s3_bucket_status_before_test.png)
...
![alt text](screenshots/lambda_s3_test_status.png)
...
![alt text](screenshots/s3_bucket_status_after_test.png)
...
```
![alt text](screenshots/cloudwatch_logs_aftertest.png)
